...
- Fixed commitments require an explicit local start. Fixed materialized occurrences require resolved instants and a resolver version. Civil dates reject impossible calendar dates. Occurrence origin identity cannot be relabelled after materialization.
...
4. Independently inspect all 18 new tables, 11 triggers, replay-blocking trigger registration, all-table sentinels, upgrade behavior, privacy deletion, bounds and recommendation-provenance shape.
