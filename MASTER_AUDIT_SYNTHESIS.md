...
|---|---|---|---|---|---|---|---|---|---|---|
| `OW-001` | CLOSED | Provide an athlete-facing per-slot implement selection for multi-prefix movements, writing to the existing `planned_slot_load_intent`. L1(a)'s "ambiguous mixed movements require athlete selection" clause has no implementation; ambiguous slots are permanently undeclared and permanently loaded. Scoped to the athlete-selection surface only; the chain-floor regression it causes at State C is independently closable and is tracked as `OW-036`. CLOSED by PR #11, commit `e44140c`: migration 063 adds `movement_load_intent`, the athlete's EXPLICIT declaration, and generation resolves it into the per-slot `planned_slot_load_intent` row L1(a) requires. The declaration is per movement while the record stays per slot because `isStrictlyBodyweight` orders the loaded and anchor pools in `movementRanking`, so a declaration changes WHICH movement the ranker picks, not merely how a slot is dosed — a post-generation per-slot editor could replace the very slot being edited and would make a block irreproducible from its inputs; slots also do not exist before generation. Owner-selected 2026-09-09. No prohibited source is used: the sole-supported-prefix rule applies only where there is no choice, taxonomy and equipment ownership are not read, and nothing retrospective is consulted. An undeclared ambiguous movement still fails closed to the loaded path. Surface is a HOW YOU LOAD THESE section in ProfileScreen. 8 store/engine tests, 27 migration checks, 5 mutations applied and all 5 caught (one escaped first and was closed by making the test distinguish the store guard from 063's trigger). | State C | 2026-08-29 | `34f91ff` | Origin `[Working-tree source: docs/WORKORDER_MASTER_AUDIT_SYNTHESIS_REMEDIATION.md; SHA-256 687617d9e6dfa7222d6cfd85fc25978caa92303109031ac0ed771bec2d20f2ec; lines 191-191; captured 2026-08-31]`; admission gate `[Working-tree source: docs/audits/AUDIT_CLAUDE_RELEASE_CLOSEOUT_34F91FF.md; SHA-256 9377394e9cb473cae76506a3e3ad12b6efbf015feed43dce5dcf0b35632fc155; lines 63-157; captured 2026-08-31]`; T0 ruling `[Source: docs/decisions/RELEASE_CANDIDATE_C1_DOCKET.md@a80f955b0d76625587023536bcc260f6d80bc2a2, lines 452-452]`; T4 corroboration `[Source: packages/inference/src/blockGenerator.ts@34f91ffe548a0b9e51db863ffc6fad993619f940, lines 844-862]` | NONE | NONE | CODE_CONFIRMED | NON_BLOCKING |
| `OW-002` | CLOSED | `resetTrainingData` leaves the athlete suspended at a frozen index whose block history was wiped, and does not refresh suspension state. Deleting only the open episode is required; a blanket delete is refused by 059 and rolls back the whole reset. CLOSED by PR #9 (merge `5f1cb6a`), commit `a67e6d1`: only the OPEN episode is deleted, placed before its program/block parents so its 059 side-cars cascade from their own episode; all three side-cars are then cleared parent-safely; `suspension: null` and `refreshSuspension()` added after the wipe. A blanket delete is refused by 059 and would roll the wipe back, so it is not used. Covered by `SuspensionResetAndSwitch.test.js` and `verify:store`; whether closed episodes should survive a wipe remains `OW-034`. | State C | 2026-08-29 | `34f91ff` | Origin `[Working-tree source: docs/WORKORDER_MASTER_AUDIT_SYNTHESIS_REMEDIATION.md; SHA-256 687617d9e6dfa7222d6cfd85fc25978caa92303109031ac0ed771bec2d20f2ec; lines 192-192; captured 2026-08-31]`; admission gate `[Working-tree source: docs/audits/AUDIT_CLAUDE_RELEASE_CLOSEOUT_34F91FF.md; SHA-256 9377394e9cb473cae76506a3e3ad12b6efbf015feed43dce5dcf0b35632fc155; lines 158-226; captured 2026-08-31]`; T4 corroboration `[Source: apps/mobile/src/state/useStore.ts@34f91ffe548a0b9e51db863ffc6fad993619f940, lines 6078-6156]` and `[Source: packages/core-db/src/schema/059_suspension_state_and_load_intent.sql@f3ebab38c703c549ca20b9bd972be915eb6dd84b, lines 147-152]` | NONE | NONE | TEST_CONFIRMED | NON_BLOCKING |
| `OW-003` | CLOSED | Add `suspension: null` to `PER_ATHLETE_RESET`. Every other per-athlete field is cleared; suspension is not, leaving the previous athlete's episode resident during the boot window and after a boot failure. CLOSED by PR #9 (merge `5f1cb6a`), commit `a67e6d1`: `PER_ATHLETE_RESET` now clears `suspension`, closing both the pre-`refreshSuspension()` window and the failed-boot case. Asserted at the exact moment `boot()` opens the incoming athlete's database file, and again on a deliberately failed boot. | State C | 2026-08-29 | `34f91ff` | Origin `[Working-tree source: docs/WORKORDER_MASTER_AUDIT_SYNTHESIS_REMEDIATION.md; SHA-256 687617d9e6dfa7222d6cfd85fc25978caa92303109031ac0ed771bec2d20f2ec; lines 192-192; captured 2026-08-31]`; admission gate `[Working-tree source: docs/audits/AUDIT_CLAUDE_RELEASE_CLOSEOUT_34F91FF.md; SHA-256 9377394e9cb473cae76506a3e3ad12b6efbf015feed43dce5dcf0b35632fc155; lines 158-226; captured 2026-08-31]`; T4 corroboration `[Source: apps/mobile/src/state/useStore.ts@34f91ffe548a0b9e51db863ffc6fad993619f940, lines 2053-2060]` | NONE | NONE | CODE_CONFIRMED | NON_BLOCKING |
| `OW-005` | CLOSED | Add a `[059]` behavioural section to `verify_migrations.mjs` asserting each trigger refusal, the one permitted transition, and 059 self-heal restoration. Sentinel registration exists; no test exercises any of the four triggers. CLOSED by PR #9 (merge `5f1cb6a`), commit `5b2c613`: `verify_migrations.mjs` `[2ab]` asserts every 059 refusal (entry immutability, close-once, no-delete-closed, frozen-program immutability), both deliberate permissions (the athlete resume and the open-episode delete the reset depends on), and self-heal restoration per trigger asserted through behaviour rather than sqlite_master presence. | State C | 2026-08-29 | `34f91ff` | Origin `[Working-tree source: docs/WORKORDER_MASTER_AUDIT_SYNTHESIS_REMEDIATION.md; SHA-256 687617d9e6dfa7222d6cfd85fc25978caa92303109031ac0ed771bec2d20f2ec; lines 193-193; captured 2026-08-31]`; admission gate `[Working-tree source: docs/audits/AUDIT_CLAUDE_RELEASE_CLOSEOUT_34F91FF.md; SHA-256 9377394e9cb473cae76506a3e3ad12b6efbf015feed43dce5dcf0b35632fc155; lines 229-295; captured 2026-08-31]`; T4 corroboration `[Source: packages/core-db/test/verify_migrations.mjs@34f91ffe548a0b9e51db863ffc6fad993619f940, lines 1932-1997]` | NONE | NONE | TEST_CONFIRMED | NON_BLOCKING |
| `OW-006` | OPEN | Compute `bodyweightDominant` from the movements placed into the block's slots rather than the whole available pool, or delete the branch. As written it requires every catalogue movement to be planned bodyweight, so it is unreachable in production and a ratified bodyweight coefficient would still not take effect. Dose-neutral today. RE-SCOPED 2026-09-09 by PR #10, commit `6e132db`, to REACHABILITY ONLY. The truthfulness half is closed: the 2026-08-29 claim that this made future bodyweight pricing "only a table edit" is withdrawn in `blockGenerator.ts`, which now records that `bodyweightDominant` is computed from the athlete's entire catalogue rather than the block's slots and is therefore always false on the shipped 300-movement corpus. `verify:blocks` now pins both branches of `schemaFatigueCost` as identical across all 4x4 (schema, phase) pairs as a TRIPWIRE, so ratifying a real coefficient fails the gate and forces reachability to be fixed in the same change instead of populating dead code (mutation-tested with a divergent table). What remains OPEN is reachability itself, which needs either a two-pass restructure of the determinism-critical generator or `OW-026` ratifying/declining a bodyweight CNS coefficient — an owner decision, so it was recorded rather than guessed at. Still dose-neutral: NON_BLOCKING. | State C | 2026-08-29 | `34f91ff` | Origin `[Working-tree source: docs/WORKORDER_MASTER_AUDIT_SYNTHESIS_REMEDIATION.md; SHA-256 687617d9e6dfa7222d6cfd85fc25978caa92303109031ac0ed771bec2d20f2ec; lines 194-194; captured 2026-08-31]`; admission gate `[Working-tree source: docs/audits/AUDIT_CLAUDE_RELEASE_CLOSEOUT_34F91FF.md; SHA-256 9377394e9cb473cae76506a3e3ad12b6efbf015feed43dce5dcf0b35632fc155; lines 296-332; captured 2026-08-31]`; T4 corroboration `[Source: packages/inference/src/blockGenerator.ts@34f91ffe548a0b9e51db863ffc6fad993619f940, lines 671-682]` and `[Source: apps/mobile/src/state/useStore.ts@34f91ffe548a0b9e51db863ffc6fad993619f940, lines 3041-3056]` | NONE | NONE | CODE_CONFIRMED | NON_BLOCKING |
| `OW-007` | CLOSED | Wrap the suspension resume action in the same action-scoped `try/catch` the entry action uses, and mount an error node inside the suspended branch. A database error on resume currently escapes with no athlete-visible message. CLOSED by PR #10, commit `6e132db`: the resume handler now uses the same action-scoped `try/catch` the pause controls use, the `suspension-error` node is mounted INSIDE the suspended branch (it previously existed only in the branch where the resume button does not), and `endSuspension` wraps its write in the same explicit transaction `beginSuspension` uses and RETHROWS so the failure reaches the handler. Five tests; three mutations applied and all three caught. | State C | 2026-08-29 | `34f91ff` | Origin `[Working-tree source: docs/WORKORDER_MASTER_AUDIT_SYNTHESIS_REMEDIATION.md; SHA-256 687617d9e6dfa7222d6cfd85fc25978caa92303109031ac0ed771bec2d20f2ec; lines 195-195; captured 2026-08-31]`; admission gate `[Working-tree source: docs/audits/AUDIT_CLAUDE_RELEASE_CLOSEOUT_34F91FF.md; SHA-256 9377394e9cb473cae76506a3e3ad12b6efbf015feed43dce5dcf0b35632fc155; lines 335-367; captured 2026-08-31]`; T4 corroboration `[Source: apps/mobile/src/screens/BlockScreen.tsx@34f91ffe548a0b9e51db863ffc6fad993619f940, lines 471-517]` | NONE | NONE | CODE_CONFIRMED | NON_BLOCKING |
...
| `OW-011` | CLOSED | Close the `verify_store_sql.mjs` `SCHEMA_FILES` gap for migration 057 (U8). The omission is deliberate and documented in the file itself, and closing it has its own blast radius — so this is scoped work, not an oversight to be silently patched. CLOSED by PR #10, commit `6e132db`: `057_block_meta_phase_invariant.sql` added to `verify_store_sql.mjs` `SCHEMA_FILES`. The feared blast radius did not exist — the chain applies clean and every existing seed already used matched (index, phase) pairs. Three checks prove the triggers are genuinely enforcing here rather than the file merely being listed: the captured field drift (index 3, `volume`) is refused on INSERT, drifting an existing row by UPDATE is refused, and a matched pair is still accepted. Mutation-tested by removing 057 again. | State A and C | 2026-08-27 | `48719b0`, still open at `34f91ff` | `[Source: HANDOVER_2026-08-27_SOL.md@48719b07988ad30d255b0fed37f45ed5db49c935, lines 167-168]` | NONE | NONE | CODE_CONFIRMED | NON_BLOCKING |
...
| `OW-017` | CLOSED | Prefix-encoded variants such as Barbell Glute Bridge and Barbell Walking Lunge carry a barbell demand invisible to the equipment filter. Inherited from the 010 model and scoped for a future per-prefix-equipment design. CLOSED 2026-09-09 by commit `9ecc5a8`. The awaited per-prefix-equipment design landed as `IMPLEMENT_REQUIREMENT` + `implementAvailable` in PR #11. Measured on the shipped corpus: **0 of 235** sole-prefix loaded movements can be planned with an implement their own `movement_equipment` rows do not require, so the condition this row describes is NOT REACHABLE today. It remains real in code — `plannedImplementFor` (`useStore.ts:1849`) consults `implementAvailable` on the DECLARED branch but not on the sole-supported-prefix fallback — so the row is closed as latent, not as fixed, and is held closed by the `[OW-017]` gate in `verify_blocks.mjs`, which fails if a library correction introduces such a movement and forces the fallback to be closed in the same change. Mutation-tested by resolving `DB` to an item no dumbbell movement requires: 67 movements named, gate failed. **UPGRADED 2026-09-10 from closed-as-latent to closed-and-FIXED** after round-2 finding 2 argued the defence-in-depth case in B3. `plannedImplementFor` now applies `implementAvailable` to the sole-prefix fallback, so the contract is no longer asymmetric. The change is DOSE-NEUTRAL by construction: `isStrictlyBodyweight` tests `=== 'Bodyweight'`, so for a sole-prefix loaded movement the value only ever moves between two non-`Bodyweight` values, and on the shipped corpus it is a literal no-op (0 of 235). Unreachability held by database shape alone was a weaker guarantee than unreachability plus a guard. | State A | 2026-07-13 | `48719b0`, closed at `a7e0fb6` | `[Source: DEVIATION_LOG.md@48719b07988ad30d255b0fed37f45ed5db49c935, lines 593-598]` | NONE | NONE | CODE_CONFIRMED | NON_BLOCKING |
...
| `OW-037` | OPEN | The athlete's load-intent declaration reaches generation but NOT the session runner, so the app contradicts its own athlete. `SessionScreen.tsx:329` derives `bodyweightMode` from `supportedPrefixes[0]`, and `SessionScreen.tsx:606` calls `logSet` with `implement=undefined`, so `useStore.ts:5739` falls back to `supportedPrefixes[0]` and records `set_prefix` from dropdown order rather than from the declaration. An athlete who declares DB for Walking Lunge is dosed as loaded by the generator, then shown "Added kg (0 = bodyweight)" and recorded as Bodyweight. Not a regression — `supportedPrefixes[0]` was always the session heuristic — but `OW-001` made the divergence meaningful, because before there was no declaration to contradict. **Escalated by round-1 audit finding F1**, which traced a consequence the original write-up missed: `loadSelection.ts:123` gates 1RM-derived target load on `!bodyweightMode`, so the athlete also receives NO computed target load. Owner-ruled 2026-09-09 as measure-only, then deferred to the active session runner work order. Remediation moves recorded `set_prefix` and therefore Effective volume / CNS-stability, so it is a dose change requiring ratification. | State C | 2026-09-09 | `1a79077` | Origin `[Source: apps/mobile/src/screens/SessionScreen.tsx@1a790776f4efb50fc2d38a58b60997579c46f310, lines 325-331]`; escalation `[Source: docs/audits/state-c-data-integrity/team-preview/round-1/reviewer-gemini.md, finding F1]`; T4 corroboration `[Source: packages/inference/src/loadSelection.ts@1a790776f4efb50fc2d38a58b60997579c46f310, lines 123-125]` | NONE | NONE | CODE_CONFIRMED | OWNER_EVIDENCE_REQUIRED |
| `OW-038` | OPEN | `verify_blocks.mjs` section `[12]` exercises the 3-tier substitution engine across the 30-movement 001-015 fixture only, so substitution behaviour over the 270 movements added by migrations 016, 037-048 and 049 is untested. Raised as round-2 finding 1 alongside `[9d]` and `[11]`; those two are dispositioned in the round-2 reconciliation (`[11]` closed by a full-corpus token check in `[F2-corpus]`, `[9d]` upheld on its LABEL only — its `fixture-chain` design is documented and deliberate, and delegates chain scoping to `[28]`). `[12]` is left open because widening substitution coverage is a change to substitution testing in its own right, not a close-out edit, and no concrete failure scenario is attached to it. | State C | 2026-09-10 | `5aad482` | `[Source: docs/audits/state-c-data-integrity/team-preview/round-2/reviewer-gemini.md, finding 1]`; T4 corroboration `[Source: packages/inference/test/verify_blocks.mjs@5aad482465c41d4c9819b706b57541db79631f53, lines 936-950]` | NONE | NONE | CODE_CONFIRMED | NON_BLOCKING |

### 4.2 Parked and Owner-Only Decisions

| work_id | status | statement | state_scope | source_date | as_of_revision | citation | supersedes | superseded_by | verification | release_effect |
|---|---|---|---|---|---|---|---|---|---|---|
| `OW-004` | CLOSED | Decide and implement mutation protection for the 059 side-cars. `block_suspension_origin` accepts both update and delete, and `suspension_episode_program` accepts delete, so the S6(b) attribution that closes P1-1 can be silently removed or re-pointed. Requires a Migration 060, therefore owner authorization. CLOSED by PR #9 (merge `5f1cb6a`), commit `5b2c613`: migration 062 (array index 60, `user_version` 61) refuses DELETE on `suspension_episode_program` and both UPDATE and DELETE on `block_suspension_origin`. Guards are parent-scoped because FK cascade actions do fire the child's BEFORE DELETE trigger. `planned_slot_load_intent` receives only a re-pointing guard and is deliberately NOT made fully immutable, because this row authorises two tables and `OW-001` still writes to the third; whether `planned_implement` becomes immutable once trained is a NEW owner decision recorded in `POST_MERGE_STATE_C_DATA_INTEGRITY_HANDBACK.md`. | State C | 2026-08-29 | `34f91ff` | Origin `[Working-tree source: docs/WORKORDER_MASTER_AUDIT_SYNTHESIS_REMEDIATION.md; SHA-256 687617d9e6dfa7222d6cfd85fc25978caa92303109031ac0ed771bec2d20f2ec; lines 193-193; captured 2026-08-31]`; admission gate `[Working-tree source: docs/audits/AUDIT_CLAUDE_RELEASE_CLOSEOUT_34F91FF.md; SHA-256 9377394e9cb473cae76506a3e3ad12b6efbf015feed43dce5dcf0b35632fc155; lines 229-295; captured 2026-08-31]`; T4 corroboration `[Source: packages/core-db/src/schema/059_suspension_state_and_load_intent.sql@f3ebab38c703c549ca20b9bd972be915eb6dd84b, lines 116-160]` | NONE | NONE | OWNER_EVIDENCE_REQUIRED | NON_BLOCKING |
...
| `OW-033` | OWNER_ONLY | Rule on the prompt-ledger whitespace conflict: keep prompt bytes verbatim and record a standing `git diff --check` exception for ledger entries, or normalize trailing whitespace on paste and note the normalization inside the entry. Held at the first option pending a ruling. **SECOND CLASS FOUND 2026-09-10 (Entry 0104):** the conflict is not limited to ledger entries. Recording an independent reviewer's report verbatim (`docs/audits/state-c-data-integrity/team-preview/round-1/reviewer-gemini.md`) introduces 14 trailing-whitespace lines, all Markdown hard breaks authored by the reviewer. Normalizing them would alter a third-party record and break the SHA-256 recorded alongside it, so they are kept. `git diff --check 1a79077..HEAD` therefore exits 2 with 15 hits across two files — 1 ledger, 14 reviewer report — while the working-tree form still exits 0, exactly the distinction the docket's §7 drew. The ruling sought is whether option (i)'s standing exception covers VERBATIM THIRD-PARTY RECORDS as well as ledger entries. | Cross-state | 2026-08-29 | `a80f955` | `[Source: docs/decisions/RELEASE_CANDIDATE_C1_DOCKET.md@a80f955b0d76625587023536bcc260f6d80bc2a2, lines 427-435]` | NONE | NONE | OWNER_EVIDENCE_REQUIRED | NON_BLOCKING |
