...
1. **RESOLVED by additive migration 050: poisoned-database self-heal formerly
   widened supplementary role eligibility.**
   ...
   Migration 050 now reasserts the declared 028 policy (every live movement is
   supplementary-eligible), installs an insert trigger for future movement
   batches, and proves fresh install, incremental upgrade and poison-repair
   convergence. Major and conditional allowlists remain unchanged.
